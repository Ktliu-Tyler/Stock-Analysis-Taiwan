...
這是一個本機 Web 儀表板，用來輔助篩選台股 1-5 天短線候選標的。系統會整合技術面、籌碼面、情緒面、風控分數、本地規則模型與持股紀錄，並可透過本機 Ollama 模型產生單檔股票或個人持股策略分析。
...
4. 在候選清單中點選股票查看單檔分析。
5. 到持股頁加入自己的股票、股數與成本。
6. 到 AI 頁選股票或帶入持股，讓 Ollama 產生分析。
